...
#include "RecordBlockEditor.h"
#include "RecordBlock.h"
#include <stdio.h>

RecordBlockEditor::RecordBlockEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors=true)
...
RecordBlockEditor::~RecordBlockEditor()
{

}

void RecordBlockEditor::comboBoxChanged(ComboBox* comboBox)
{
...
void RecordBlockEditor::updateSettings()
{
	EventSources s;
	String name;
...
void RecordBlockEditor::saveCustomParameters(XmlElement* xml)
{

    XmlElement* info = xml->createNewChildElement("PARAMETERS");

    info->setAttribute("Type", "RecordBlockEditor");
...
void RecordBlockEditor::loadCustomParameters(XmlElement* xml)
{
